...
fig9 = px.scatter(cases, x="date", y="positive_pct_change", trendline="lowess"
                  , title="positive_pct_change"
...
fig10 = px.scatter(cases, x="date", y="negative_pct_change", color="negative_pct_change"
...
fig11 = px.scatter(cases, x="date", y="death_pct_change", color="death_pct_change"
...
fig12 = px.scatter(cases, x="date", y="hospitalized_pct_change", color="hospitalized_pct_change"
...
fig13 = px.scatter(cases, x="date", y="total_cases_pct_change", color="total_cases_pct_change"
...
fig15 = px.scatter(cases_melted, x="date", y="value"
...
fig22 = px.scatter(cases_melted, x="date", y="value"
...
fig23 = px.bar(cases_melted, x="date", y="value"
                 , color="variable", facet_row="variable", facet_col="dayofweek"
                 , color_continuous_scale=px.colors.sequential.Inferno)
...
fig25 = px.bar(cases_melted, x="date", y="value"
                 , color="variable"
                 , color_continuous_scale=px.colors.sequential.Inferno)
...
fig26 = px.bar(cases_melted, x="date", y="value"
                 , color="dayofweek"
                 , color_continuous_scale=px.colors.sequential.Inferno)
...
fig27 = px.bar(cases_melted, x="date", y="value"
